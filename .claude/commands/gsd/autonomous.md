...
<execution_context>
@C:/1Wes/all-in-badminton-app/.claude/get-shit-done/workflows/autonomous.md
...
<process>
Execute the autonomous workflow from @C:/1Wes/all-in-badminton-app/.claude/get-shit-done/workflows/autonomous.md end-to-end.
