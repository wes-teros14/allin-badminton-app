...
<execution_context>
@C:/1Wes/all-in-badminton-app/.claude/get-shit-done/workflows/spike.md
...
<process>
Execute the spike workflow from @C:/1Wes/all-in-badminton-app/.claude/get-shit-done/workflows/spike.md end-to-end.
