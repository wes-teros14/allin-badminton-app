...
<execution_context>
@C:/1Wes/all-in-badminton-app/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @C:/1Wes/all-in-badminton-app/.claude/get-shit-done/workflows/manager.md end-to-end.
