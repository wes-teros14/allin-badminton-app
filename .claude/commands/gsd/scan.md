...
<execution_context>
@C:/1Wes/all-in-badminton-app/.claude/get-shit-done/workflows/scan.md
</execution_context>

<process>
Execute the scan workflow from @C:/1Wes/all-in-badminton-app/.claude/get-shit-done/workflows/scan.md end-to-end.
</process>
