...
<reference>
@C:/1Wes/all-in-badminton-app/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/1Wes/all-in-badminton-app/.claude/get-shit-done/references/user-profiling.md` to load:
