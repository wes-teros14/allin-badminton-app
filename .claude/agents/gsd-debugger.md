...
<required_reading>
@C:/1Wes/all-in-badminton-app/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/1Wes/all-in-badminton-app/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/1Wes/all-in-badminton-app/.claude
                  → checks C:/1Wes/all-in-badminton-app/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/1Wes/all-in-badminton-app/.claude/get-shit-done
                  → writes to C:/1Wes/all-in-badminton-app/.claude/get-shit-done/hooks/
...
@C:/1Wes/all-in-badminton-app/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/1Wes/all-in-badminton-app/.claude/get-shit-done/references/common-bug-patterns.md
