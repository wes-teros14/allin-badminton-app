...
Use template from `C:/1Wes/all-in-badminton-app/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/1Wes/all-in-badminton-app/.claude/get-shit-done/templates/UI-SPEC.md`
