...
<required_reading>
@C:/1Wes/all-in-badminton-app/.claude/get-shit-done/references/verification-overrides.md
...
@C:/1Wes/all-in-badminton-app/.claude/get-shit-done/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@C:/1Wes/all-in-badminton-app/.claude/get-shit-done/references/few-shot-examples/verifier.md
