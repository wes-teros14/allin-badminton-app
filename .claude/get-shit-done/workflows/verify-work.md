...
<template>
@C:/1Wes/all-in-badminton-app/.claude/get-shit-done/templates/UAT.md
</template>
...
Read and follow `C:/1Wes/all-in-badminton-app/.claude/get-shit-done/workflows/transition.md`.
...
```bash
node "C:/1Wes/all-in-badminton-app/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @C:/1Wes/all-in-badminton-app/.claude/get-shit-done/workflows/diagnose-issues.md
