...
@C:/1Wes/all-in-badminton-app/.claude/get-shit-done/references/revision-loop.md
...
**If found:**
1. Read template: `C:/1Wes/all-in-badminton-app/.claude/get-shit-done/templates/VALIDATION.md`
...
${TDD_MODE === 'true' ? `
<tdd_mode_active>
**TDD Mode is ENABLED.** Apply TDD heuristics from @C:/1Wes/all-in-badminton-app/.claude/get-shit-done/references/tdd.md to all eligible tasks:
