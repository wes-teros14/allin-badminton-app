...
@C:/1Wes/all-in-badminton-app/.claude/get-shit-done/references/git-integration.md
</required_reading>
...
See `C:/1Wes/all-in-badminton-app/.claude/get-shit-done/references/tdd.md` for structure.
</tdd_plan_execution>
...
See C:/1Wes/all-in-badminton-app/.claude/get-shit-done/references/checkpoints.md for details.
</step>
