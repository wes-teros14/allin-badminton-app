...
```
Task(
  prompt="Read C:/1Wes/all-in-badminton-app/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/1Wes/all-in-badminton-app/.claude/get-shit-done/templates/VALIDATION.md`
