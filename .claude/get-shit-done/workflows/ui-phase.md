...
```markdown
Read C:/1Wes/all-in-badminton-app/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/1Wes/all-in-badminton-app/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/1Wes/all-in-badminton-app/.claude/agents/gsd-ui-checker.md for instructions.
