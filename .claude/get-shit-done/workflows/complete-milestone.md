...
```bash
node "C:/1Wes/all-in-badminton-app/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `C:/1Wes/all-in-badminton-app/.claude/get-shit-done/templates/retrospective.md`.
