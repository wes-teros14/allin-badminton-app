...
```bash
INIT=$(node "C:/1Wes/all-in-badminton-app/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/1Wes/all-in-badminton-app/.claude/get-shit-done/templates/spec.md.
