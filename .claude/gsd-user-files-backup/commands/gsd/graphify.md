...
**CJS-only (graphify):** `graphify` subcommands are not registered on `gsd-sdk query`. Use `node C:/1Wes/all-in-badminton-app/.claude/get-shit-done/bin/gsd-tools.cjs graphify …` as documented in this command and in `docs/CLI-TOOLS.md`. Other tooling may still use `gsd-sdk query` where a handler exists.
...
Knowledge graph is disabled. To activate:
  ...
  node C:/1Wes/all-in-badminton-app/.claude/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node C:/1Wes/all-in-badminton-app/.claude/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node C:/1Wes/all-in-badminton-app/.claude/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "C:/1Wes/all-in-badminton-app/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: C:/1Wes/all-in-badminton-app/.claude/get-shit-done/bin/gsd-tools.cjs
...
4. **Write diff snapshot:**
   ```
   node \"C:/1Wes/all-in-badminton-app/.claude/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```
