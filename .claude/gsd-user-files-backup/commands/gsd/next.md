...
<execution_context>
@C:/1Wes/all-in-badminton-app/.claude/get-shit-done/workflows/next.md
</execution_context>

<process>
Execute the next workflow from @C:/1Wes/all-in-badminton-app/.claude/get-shit-done/workflows/next.md end-to-end.
</process>
