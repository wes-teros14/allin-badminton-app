-- =============================================================
-- Migration: 074_add_status_to_get_session_finance
-- Appends session lifecycle status to the finance RPC return
-- signature so the Finance page can partition sessions into
-- completed vs in-flight totals.
--
-- SIGNATURE-ONLY CHANGE. No existing computed column changes
-- value. Postgres cannot alter a function's return type in
-- place, so this DROPs and re-CREATEs, matching the pattern
-- already used by migrations 060 and 065.
-- =============================================================
