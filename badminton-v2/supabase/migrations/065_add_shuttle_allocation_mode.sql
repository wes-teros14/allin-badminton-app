-- =============================================================
-- Migration: 065_add_shuttle_allocation_mode
-- Adds explicit finance allocation mode metadata to sessions and
-- extends the finance RPC without changing existing calculations.
-- =============================================================

CREATE TYPE public.shuttle_allocation_mode AS ENUM (
  'auto',
  'manual'
);

ALTER TABLE public.sessions
  ADD COLUMN shuttle_allocation_mode public.shuttle_allocation_mode NOT NULL DEFAULT 'auto';
