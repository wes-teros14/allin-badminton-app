...
- @C:/1Wes/all-in-badminton-app/.codex/get-shit-done/workflows/complete-milestone.md (main workflow)
- @C:/1Wes/all-in-badminton-app/.codex/get-shit-done/templates/milestone-archive.md (archive template)
  </execution_context>
