...
<execution_context>
@C:/1Wes/all-in-badminton-app/.codex/get-shit-done/workflows/manager.md
...
Read and execute `C:/1Wes/all-in-badminton-app/.codex/get-shit-done/workflows/analyze-dependencies.md` end-to-end.
