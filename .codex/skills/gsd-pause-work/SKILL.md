...
<execution_context>
@C:/1Wes/all-in-badminton-app/.codex/get-shit-done/workflows/pause-work.md
</execution_context>
...
Read and execute `C:/1Wes/all-in-badminton-app/.codex/get-shit-done/workflows/session-report.md` end-to-end.
