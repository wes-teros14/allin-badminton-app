...
```markdown
Read C:/1Wes/all-in-badminton-app/.codex/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/1Wes/all-in-badminton-app/.codex/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/1Wes/all-in-badminton-app/.codex/agents/gsd-ui-checker.md for instructions.
