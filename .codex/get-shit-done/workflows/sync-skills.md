...
INSTALL_JS_GLOBAL="C:/1Wes/all-in-badminton-app/.codex/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/1Wes/all-in-badminton-app/.codex/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
