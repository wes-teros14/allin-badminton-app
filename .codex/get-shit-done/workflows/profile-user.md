...
Key references:
- @C:/1Wes/all-in-badminton-app/.codex/get-shit-done/references/ui-brand.md (display patterns)
- @C:/1Wes/all-in-badminton-app/.codex/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/1Wes/all-in-badminton-app/.codex/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/1Wes/all-in-badminton-app/.codex/get-shit-done/USER-PROFILE.md"
...
```bash
cp "C:/1Wes/all-in-badminton-app/.codex/get-shit-done/USER-PROFILE.md" "C:/1Wes/all-in-badminton-app/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/1Wes/all-in-badminton-app/.codex/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/1Wes/all-in-badminton-app/.codex/get-shit-done/references/user-profiling.md`
...
Reference: @C:/1Wes/all-in-badminton-app/.codex/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to C:/1Wes/all-in-badminton-app/.codex/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to C:/1Wes/all-in-badminton-app/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/1Wes/all-in-badminton-app/.codex/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated $gsd-dev-preferences at C:/1Wes/all-in-badminton-app/.codex/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to C:/1Wes/all-in-badminton-app/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="C:/1Wes/all-in-badminton-app/.codex/USER-PROFILE.backup.md"
```
...
Your profile:    C:/1Wes/all-in-badminton-app/.codex/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gsd-dev-preferences   C:/1Wes/all-in-badminton-app/.codex/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        C:/1Wes/all-in-badminton-app/.codex/AGENTS.md
```
