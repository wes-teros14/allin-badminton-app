...
```
Agent(
  prompt="Read C:/1Wes/all-in-badminton-app/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/1Wes/all-in-badminton-app/.codex/get-shit-done/templates/SECURITY.md`
