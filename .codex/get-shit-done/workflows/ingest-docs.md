...
```bash
INIT=$(node "C:/1Wes/all-in-badminton-app/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/1Wes/all-in-badminton-app/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
