...
<template>
@C:/1Wes/all-in-badminton-app/.codex/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@C:/1Wes/all-in-badminton-app/.codex/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `C:/1Wes/all-in-badminton-app/.codex/get-shit-done/workflows/transition.md`.
...
- Follow @C:/1Wes/all-in-badminton-app/.codex/get-shit-done/workflows/diagnose-issues.md
