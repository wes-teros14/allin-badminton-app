...
Reference full template: `C:/1Wes/all-in-badminton-app/.codex/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/1Wes/all-in-badminton-app/.codex/get-shit-done/templates/state.md`.
