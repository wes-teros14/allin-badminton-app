...
Use template from `C:/1Wes/all-in-badminton-app/.codex/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/1Wes/all-in-badminton-app/.codex/get-shit-done/templates/UI-SPEC.md`
